...
import (
	...
	"github.com/lijiaocn/workspace/studys/study-k8s-develop/code-generator/example-1/internal/client/selfcrd/clientset/versioned/scheme"
...
// CrdV1Client is used to interact with features provided by the crd.lijiaocn.com group.
type CrdV1Client struct {
	restClient rest.Interface
}

func (c *CrdV1Client) SelfCRDs(namespace string) SelfCRDInterface {
