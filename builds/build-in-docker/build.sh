...
PROJECT_VERSION="v0.0.1"           # you projec's version
...
REMOTE_ROOT=/go/src/github.com/lijiaocn/build-in-docker/ # workdir in docker
...
# if codes is not here, you can clone it at here.
#	cd $BASEDIR
...
#		fi
#	else
#		git clone --depth 1 --single-branch --branch $PROJECT_VERSION https://www.github.com/cloudnativelabs/kube-router.git ${PROJECT_NAME}
#	fi
	return
}
